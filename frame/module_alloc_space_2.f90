...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",3788,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",8803,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",8862,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",8971,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",9030,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",9275,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",9443,&
...
((((em31)-(sm31)+1))*(((model_config_rec%mosaic_cat)-(1)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",9884,&
...
((((em31)-(sm31)+1))*(((model_config_rec%mosaic_cat)-(1)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",10297,&
...
((((em31)-(sm31)+1))*(((model_config_rec%mosaic_cat)-(1)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",10710,&
...
((((em31)-(sm31)+1))*(((model_config_rec%mosaic_cat_soil)-(1)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",11123,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",14356,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",14769,&
...
((((em31)-(sm31)+1))*(((em32)-(sm32)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",15319,&
...
((((em31)-(sm31)+1))*(((em32)-(sm32)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",15378,&
...
((((em31)-(sm31)+1))*(((em32)-(sm32)+1))*(((model_config_rec%cam_abs_dim2)-(1)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",17906,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",17955,&
...
((((em31)-(sm31)+1))*(((em32)-(sm32)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",18022,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",18131,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",18140,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",18190,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",18249,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",18435,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",18494,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",18553,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",18662,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",18721,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",18730,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",18780,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",18898,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",18907,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19025,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19075,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19103,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19153,&
...
((((em31)-(sm31)+1))*(((em33)-(sm33)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19162,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19212,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19337,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19403,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19521,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19580,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19639,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19873,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19930,&
...
((((model_config_rec%track_loc_in)-(1)+1))*(((em32)-(sm32)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19939,&
...
((((model_config_rec%track_loc_in)-(1)+1))*(((em32)-(sm32)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",19996,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20044,&
...
((((model_config_rec%track_loc_in)-(1)+1))*(((em32)-(sm32)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20110,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20158,&
...
((((model_config_rec%track_loc_in)-(1)+1))*(((em32)-(sm32)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20167,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20215,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20329,&
...
((((model_config_rec%track_loc_in)-(1)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20338,&
...
((((model_config_rec%track_loc_in)-(1)+1))*(((em32)-(sm32)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20395,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20500,&
...
((((model_config_rec%track_loc_in)-(1)+1))*(((em32)-(sm32)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20566,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20614,&
...
((((model_config_rec%track_loc_in)-(1)+1))*(((em32)-(sm32)+1))) * 4
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20623,&
...
ELSE
  ...
  if (ierr.ne.0) then
    CALL wrf_error_fatal3("<stdin>",20671,&
