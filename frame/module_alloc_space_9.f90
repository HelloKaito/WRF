...
CONTAINS
   ...
   SUBROUTINE alloc_space_field_core_9 ( grid,   id, setinitval_in ,  tl_in , inter_domain_in , okay_to_alloc_in, num_bytes_allocated , &
   ...
   END SUBROUTINE alloc_space_field_core_9

END MODULE module_alloc_space_9
