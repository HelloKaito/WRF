...
IF ( ASSOCIATED( grid%ph_bxs ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",2746,&
...
IF ( ASSOCIATED( grid%ph_bys ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",2762,&
...
IF ( ASSOCIATED( grid%th_upstream_x ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",2930,&
...
IF ( ASSOCIATED( grid%tlwup ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",7339,&
...
IF ( ASSOCIATED( grid%slwdn ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",7346,&
...
IF ( ASSOCIATED( grid%rvshten ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",7395,&
...
IF ( ASSOCIATED( grid%rqsshten ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",7430,&
...
IF ( ASSOCIATED( grid%w0avg ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",7535,&
...
IF ( ASSOCIATED( grid%rainc ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",7542,&
...
IF ( ASSOCIATED( grid%i_rainc ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",7563,&
...
IF ( ASSOCIATED( grid%lengath2d ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12148,&
...
IF ( ASSOCIATED( grid%cmfmc ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12169,&
...
IF ( ASSOCIATED( grid%rliq2 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12225,&
...
IF ( ASSOCIATED( grid%vflx_cu ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12267,&
...
IF ( ASSOCIATED( grid%slten_cu ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12281,&
...
IF ( ASSOCIATED( grid%qvten_cu ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12302,&
...
IF ( ASSOCIATED( grid%qiten_cu ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12316,&
...
IF ( ASSOCIATED( grid%cbmf_cu ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12323,&
...
IF ( ASSOCIATED( grid%wlcl_cu ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12351,&
...
IF ( ASSOCIATED( grid%qtsrc_cu ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12393,&
...
IF ( ASSOCIATED( grid%emkfbup_cu ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12414,&
...
IF ( ASSOCIATED( grid%tkeavg_cu ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12442,&
...
IF ( ASSOCIATED( grid%riwp_cu ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12470,&
...
IF ( ASSOCIATED( grid%wu_cu ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12484,&
...
IF ( ASSOCIATED( grid%ufrc_cu ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12491,&
...
IF ( ASSOCIATED( grid%vu_cu ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12526,&
...
IF ( ASSOCIATED( grid%uu_emf_cu ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12547,&
...
IF ( ASSOCIATED( grid%cufrc_cu ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12596,&
...
IF ( ASSOCIATED( grid%flxsnow_cu ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12652,&
...
IF ( ASSOCIATED( grid%ntraprd_cu ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12659,&
...
IF ( ASSOCIATED( grid%aquad_cu ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12694,&
...
IF ( ASSOCIATED( grid%cquad_cu ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12708,&
...
IF ( ASSOCIATED( grid%exit_uwcu_cu ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12729,&
...
IF ( ASSOCIATED( grid%limit_shcu_cu ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12806,&
...
IF ( ASSOCIATED( grid%limit_emf_cu ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12834,&
...
IF ( ASSOCIATED( grid%limit_cinlcl_cu ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12841,&
...
IF ( ASSOCIATED( grid%cldfra_mp ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12897,&
...
IF ( ASSOCIATED( grid%iradius ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12911,&
...
IF ( ASSOCIATED( grid%cldfral ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12939,&
...
IF ( ASSOCIATED( grid%numc ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12946,&
...
IF ( ASSOCIATED( grid%lhtran ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",12995,&
...
IF ( ASSOCIATED( grid%snowdp ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13009,&
...
IF ( ASSOCIATED( grid%t_veg ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13044,&
...
IF ( ASSOCIATED( grid%h2ocan ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13051,&
...
IF ( ASSOCIATED( grid%h2ocan_col ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13058,&
...
IF ( ASSOCIATED( grid%t2m_max ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13065,&
...
IF ( ASSOCIATED( grid%t2clm ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13079,&
...
IF ( ASSOCIATED( grid%h2osoi_liq_s3 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13107,&
...
IF ( ASSOCIATED( grid%h2osoi_liq_s5 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13121,&
...
IF ( ASSOCIATED( grid%h2osoi_liq3 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13142,&
...
IF ( ASSOCIATED( grid%h2osoi_liq5 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13156,&
...
IF ( ASSOCIATED( grid%h2osoi_liq8 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13177,&
...
IF ( ASSOCIATED( grid%h2osoi_ice_s5 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13226,&
...
IF ( ASSOCIATED( grid%h2osoi_ice6 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13268,&
...
IF ( ASSOCIATED( grid%t_soisno_s2 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13310,&
...
IF ( ASSOCIATED( grid%t_soisno_s4 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13324,&
...
IF ( ASSOCIATED( grid%t_soisno1 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13338,&
...
IF ( ASSOCIATED( grid%t_soisno4 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13359,&
...
IF ( ASSOCIATED( grid%snowrds5 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13471,&
...
IF ( ASSOCIATED( grid%t_lake1 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13478,&
...
IF ( ASSOCIATED( grid%t_lake3 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13492,&
...
IF ( ASSOCIATED( grid%t_lake4 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13499,&
...
IF ( ASSOCIATED( grid%t_lake5 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13506,&
...
IF ( ASSOCIATED( grid%h2osoi_vol2 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13555,&
...
IF ( ASSOCIATED( grid%h2osoi_vol3 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13562,&
...
IF ( ASSOCIATED( grid%h2osoi_vol4 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13569,&
...
IF ( ASSOCIATED( grid%albedosubgrid ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13618,&
...
IF ( ASSOCIATED( grid%lhsubgrid ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13625,&
...
IF ( ASSOCIATED( grid%lwupsubgrid ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13639,&
...
IF ( ASSOCIATED( grid%sabgsubgrid ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13660,&
...
IF ( ASSOCIATED( grid%nrasubgrid ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13667,&
...
IF ( ASSOCIATED( grid%ssib_fm ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13681,&
...
IF ( ASSOCIATED( grid%ssib_shf ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13723,&
...
IF ( ASSOCIATED( grid%ssib_egs ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13737,&
...
IF ( ASSOCIATED( grid%ssib_ect ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13751,&
...
IF ( ASSOCIATED( grid%ssib_sdn ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13772,&
...
IF ( ASSOCIATED( grid%ssib_ldn ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13786,&
...
IF ( ASSOCIATED( grid%ssib_lup ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13793,&
...
IF ( ASSOCIATED( grid%isnow ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13849,&
...
IF ( ASSOCIATED( grid%wo1 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13891,&
...
IF ( ASSOCIATED( grid%tssno1 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13905,&
...
IF ( ASSOCIATED( grid%bto1 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13919,&
...
IF ( ASSOCIATED( grid%flo1 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13940,&
...
IF ( ASSOCIATED( grid%bio1 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13947,&
...
IF ( ASSOCIATED( grid%ho1 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13961,&
...
IF ( ASSOCIATED( grid%wo2 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13975,&
...
IF ( ASSOCIATED( grid%tssn2 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",13982,&
...
IF ( ASSOCIATED( grid%dzo3 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14052,&
...
IF ( ASSOCIATED( grid%tssno3 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14073,&
...
IF ( ASSOCIATED( grid%bto3 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14087,&
...
IF ( ASSOCIATED( grid%blo3 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14122,&
...
IF ( ASSOCIATED( grid%wo4 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14143,&
...
IF ( ASSOCIATED( grid%tssn4 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14150,&
...
IF ( ASSOCIATED( grid%bwo4 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14164,&
...
IF ( ASSOCIATED( grid%cto4 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14178,&
...
IF ( ASSOCIATED( grid%fio4 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14185,&
...
IF ( ASSOCIATED( grid%blo4 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14206,&
...
IF ( ASSOCIATED( grid%t_grnd2d ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14262,&
...
IF ( ASSOCIATED( grid%dz_lake3d ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14290,&
...
IF ( ASSOCIATED( grid%t_soisno3d ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14297,&
...
IF ( ASSOCIATED( grid%dz3d ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14332,&
...
IF ( ASSOCIATED( grid%watsat3d ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14346,&
...
IF ( ASSOCIATED( grid%csol3d ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14353,&
...
IF ( ASSOCIATED( grid%tkdry3d ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14367,&
...
IF ( ASSOCIATED( grid%tksatu3d ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14374,&
...
IF ( ASSOCIATED( grid%u_pl ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14388,&
...
IF ( ASSOCIATED( grid%v_pl ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14395,&
...
IF ( ASSOCIATED( grid%td_pl ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14430,&
...
IF ( ASSOCIATED( grid%q_zl ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14500,&
...
IF ( ASSOCIATED( grid%tcoli_max ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14507,&
...
IF ( ASSOCIATED( grid%vil ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14535,&
...
IF ( ASSOCIATED( grid%radarvil ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14542,&
...
IF ( ASSOCIATED( grid%fzlev ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14556,&
...
IF ( ASSOCIATED( grid%qicing_lg ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14577,&
...
IF ( ASSOCIATED( grid%qicing_lg_max ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14591,&
...
IF ( ASSOCIATED( grid%qicing_sm_max ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14598,&
...
IF ( ASSOCIATED( grid%icing_sm ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14612,&
...
IF ( ASSOCIATED( grid%afwa_mslp ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14619,&
...
IF ( ASSOCIATED( grid%afwa_totprecip ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14703,&
...
IF ( ASSOCIATED( grid%afwa_rain ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14710,&
...
IF ( ASSOCIATED( grid%afwa_fzra ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14731,&
...
IF ( ASSOCIATED( grid%afwa_vis ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14745,&
...
IF ( ASSOCIATED( grid%afwa_vis_dust ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14759,&
...
IF ( ASSOCIATED( grid%afwa_cape ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14780,&
...
IF ( ASSOCIATED( grid%afwa_cin ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14787,&
...
IF ( ASSOCIATED( grid%afwa_cape_mu ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14794,&
...
IF ( ASSOCIATED( grid%afwa_cin_mu ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14801,&
...
IF ( ASSOCIATED( grid%midrh_min_old ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14843,&
...
IF ( ASSOCIATED( grid%afwa_hail ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14850,&
...
IF ( ASSOCIATED( grid%afwa_llws ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14857,&
...
IF ( ASSOCIATED( grid%afwa_hail_new5 ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14899,&
...
IF ( ASSOCIATED( grid%afwa_hail_newstd ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14913,&
...
IF ( ASSOCIATED( grid%th_old ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14948,&
...
IF ( ASSOCIATED( grid%qv_old ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14955,&
...
IF ( ASSOCIATED( grid%kext_ql ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14962,&
...
IF ( ASSOCIATED( grid%kext_qic ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14969,&
...
IF ( ASSOCIATED( grid%kext_qs ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",14990,&
...
IF ( ASSOCIATED( grid%kext_qh ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15004,&
...
IF ( ASSOCIATED( grid%kext_qa ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15011,&
...
IF ( ASSOCIATED( grid%kext_ft_qic ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15018,&
...
IF ( ASSOCIATED( grid%kext_ft_qip ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15025,&
...
IF ( ASSOCIATED( grid%induc ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15074,&
...
IF ( ASSOCIATED( grid%elecz ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15116,&
...
IF ( ASSOCIATED( grid%pot ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15123,&
...
IF ( ASSOCIATED( grid%light ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15130,&
...
IF ( ASSOCIATED( grid%lightdens ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15137,&
...
IF ( ASSOCIATED( grid%field_u_tend_perturb ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15172,&
...
IF ( ASSOCIATED( grid%field_v_tend_perturb ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15179,&
...
IF ( ASSOCIATED( grid%field_t_tend_perturb ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15186,&
...
IF ( ASSOCIATED( grid%landmask ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15193,&
...
IF ( ASSOCIATED( grid%sst_input ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15214,&
...
IF ( ASSOCIATED( grid%tracer_bye ) ) THEN 
 ...
 if (ierr.ne.0) then
 CALL wrf_error_fatal3("<stdin>",15259,&
   ...
   END SUBROUTINE init_module_domain
      ...
      SUBROUTINE domain_clock_get( grid, current_time,                &
        ...
        IF ( PRESENT( current_timestr_frac ) ) THEN
          ...
          IF ( rc /= WRFU_SUCCESS ) THEN
            CALL wrf_error_fatal3("<stdin>",15791,&
      ...
      SUBROUTINE domain_alarm_create( grid, alarm_id, interval, &
        ...
        ENDIF
        IF ( rc /= WRFU_SUCCESS ) THEN
          CALL wrf_error_fatal3("<stdin>",15970,&
      ...
      SUBROUTINE domain_time_test ( grid, pre_str )
        ...
        IF ( self_test_domain ) THEN
          ...
          IF ( rc /= WRFU_SUCCESS ) THEN
            CALL wrf_error_fatal3("<stdin>",16323,&
